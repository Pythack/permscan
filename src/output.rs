//! functions to output permscan output
...
// A wrapper around print_results_merge() and print_results_nomerge()
...
// Prints results. Called when opt.merge is false
...
// Prints results. Called when opt.merge is true
